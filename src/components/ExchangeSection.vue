    ...
    <div>
        <div class="exchange mt-2 p-3 rounded-xl">
            <div class="relative">
                ...
                <div>
                    <input type="number" id="you-send" class="w-full outline-none p-3 rounded-lg mt-2">
                    <div class="absolute flex items-center top-1/2 right-5 gap-2">
                        <img src="/public/images/coin.png" class="w-8" alt="">
                        <h4 class="font-semibold">TAPS</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                <label for="you-send" class="block text-white">You recieve</label>
                <div>
                    <input type="number" id="you-send" class="w-full outline-none p-3 rounded-lg mt-2">
                    <div class="absolute flex items-center top-1/2 right-5 gap-2">
                        <img src="/public/images/toncoin.png" class="w-8" alt="">
                        <h4 class="font-semibold">TON</h4>
                    </div>
                </div>
            </div>
